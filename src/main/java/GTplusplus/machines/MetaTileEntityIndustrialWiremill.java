...
public class MetaTileEntityIndustrialWiremill extends IndustrialMachine {
    ...
    public MetaTileEntityIndustrialWiremill(String metaTileEntityId) {
    ...
    public ICubeRenderer getBaseTexture(IMultiblockPart sourcePart) {
        return GTppTextures.WIRE_CASING;
    }

    protected IBlockState getCasingState() {
    	return GTppMetaBlocks.MULTIBLOCK_CASING.getState(GTppMultiblockCasing.CasingType.WIRE_CASING);
    }
}