...
public class IndustrialMaceratorInfo extends MultiblockInfoPage {
    ...
    public MultiblockControllerBase getController() {
        return GTppTileEntities.INDUSTRIAL_MACERATOR;
    }
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        MultiblockShapeInfo shapeInfo = MultiblockShapeInfo.builder()
            ...
            .aisle("XXX", "C#E", "XXX")
            .aisle("XXX", "XIX", "XXX")
            .where('C', GTppTileEntities.INDUSTRIAL_MACERATOR, EnumFacing.WEST)
            .where('X', GTppMetaBlocks.MULTIBLOCK_CASING.getState(GTppMultiblockCasing.CasingType.MACERATION_CASING))
