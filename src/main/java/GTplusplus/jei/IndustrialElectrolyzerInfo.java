...
public class IndustrialElectrolyzerInfo extends MultiblockInfoPage {
    ...
    public MultiblockControllerBase getController() {
        return GTppTileEntities.INDUSTRIAL_ELECTROLYZER;
    }
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        MultiblockShapeInfo shapeInfo = MultiblockShapeInfo.builder()
            ...
            .aisle("XXX", "C#E", "XXX")
            .aisle("XXX", "XIX", "XXX")
            .where('C', GTppTileEntities.INDUSTRIAL_ELECTROLYZER, EnumFacing.WEST)
            .where('X', GTppMetaBlocks.MULTIBLOCK_CASING.getState(GTppMultiblockCasing.CasingType.ELECTROLYZER_CASING))
