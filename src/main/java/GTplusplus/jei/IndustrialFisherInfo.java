...
public class IndustrialFisherInfo extends MultiblockInfoPage {
    ...
    public MultiblockControllerBase getController() {
        return GTppTileEntities.INDUSTRIAL_FISHER;
    }
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        MultiblockShapeInfo shapeInfo = MultiblockShapeInfo.builder()
            ...
            .where('C', GTppTileEntities.INDUSTRIAL_FISHER, EnumFacing.SOUTH)
            .where('X', GTppMetaBlocks.MULTIBLOCK_CASING.getState(GTppMultiblockCasing.CasingType.FISHER_CASING))
