...
public class GTppMetaBlocks {


    public static GTppMultiblockCasing MULTIBLOCK_CASING;

    public static void init() {
    	MULTIBLOCK_CASING = new GTppMultiblockCasing();
    	MULTIBLOCK_CASING.setRegistryName("gtpp_multiblock_casing");
    }
